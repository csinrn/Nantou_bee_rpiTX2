...
while(1)
{
	...
	{	
		...
		list($dataset,$type,$act,$datex,$min,$sec,$hive,$dbx,$location) =  explode(":",$buf);
		...
		if($new_table==0)
		{
		$sqlx = "INSERT INTO `bee_hive405`.`$new_table_name` (`ID` ,`DATE`,`ACTION`,`HIVE`)
								   VALUES (NULL , '$date', '$act', '$hive')";
